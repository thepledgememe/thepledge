...
const HexDisplay: React.FC = () => {
  ...
  return (
    <div className={styles.hexDisplay}>
      ...
      <button title="VectorLines" className={styles.button}>
        <img src={VectorLines} alt="Share" className={styles.img} />
      </button>
      <button title="Eagles" className={styles.button}>
        <img src={Eagle} alt="Share" className={styles.eagleImg} style={{width:"35px",height:"35px"}} />
      </button> */}
      <button title="Tg" className={styles.button} ref={telegramRef} onClick={() => handleClick(CONFIG.LINKS.TELEGRAM)}>
        <img src={Tg} alt="Share" className={styles.img} />
      </button>
      <button title="Twitter" className={styles.button} ref={xRef} onClick={() => handleClick(CONFIG.LINKS.X)}>
        <img src={Twitter} alt="Share" className={styles.img} />
      </button>
      <button title="Discord" className={styles.button} ref={discordRef} onClick={() => handleClick(CONFIG.LINKS.DISCORD)}>
        <img src={DiscordIcon} alt="Share" className={styles.img} />
      </button>
      <button title="Instagram" className={styles.button} ref={instagramRef} onClick={() => handleClick(CONFIG.LINKS.INSTAGRAM)}>
